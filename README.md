...
<a id="sa4"></a>
## フォントが標準よりやや大きくなっている
フォントが標準では少し読みにくいかもしれません。そのため、あらかじめフォントサイズの変更画面を作っておいて、「標準」を1.2em、「細い」を0.8em、「太い」を1.4emなどとしておくことをおすすめします。別に標準ページと子供にやさしいページでフォントサイズを変えるのもいいです。(テンプレートは後者の方法)
